...
public:
    struct Configuration {
        ...
        Configuration& setListMark(char lm) {
            this->listmark = lm;
            return *this;
        }
        Configuration& setEmMark(char em) {
            this->emmark = em;
            return *this;
        }
        Configuration& setStrongMark(char sm) {
            this->strongmark = sm;
            return *this;
        }
        Configuration& setHeaderStyle(Html2Markdown::Configuration::HeaderStyle hs) {
            this->headerstyle = hs;
            return *this;
        }
        Configuration& setCodeblockStyle(Html2Markdown::Configuration::CodeblockStyle cs) {
            this->codeblockstype = cs;
            return *this;
        }
        Configuration& setEnableExtra(bool flag) {
            this->enableextra = flag;
            return *this;
        }
